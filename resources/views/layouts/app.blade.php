...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        .link {
            @apply font-medium text-gray-400 underline decoration-pink-500
        }
...
<body class="container mx-auto mt-10 mb-10 max-w-lg">
    ...
    <div x-data="{ flash: true }">
        @if (session()->has('success'))
            <div x-show="flash"
                class="relative mb-10 rounded border border-green-400 bg-green-100 px-3 py-3 text-lg text-green-700"
                role="alert">
                <strong class="bold">Success!</strong>
                <div>
                    {{ session('success') }}
                </div>
